...
def generate_fraud_data(
    ...
    legitimate_transactions = {
        ...
        "merchant_category": np.random.choice(
            ["retail", "food", "gas", "online"], num_legitimate, p=[0.3, 0.3, 0.2, 0.2]
        ),
    ...
    fraud_transactions = {
        ...
        "merchant_category": np.random.choice(
            ["retail", "food", "gas", "online"], num_fraud, p=[0.1, 0.1, 0.1, 0.7]
        ),
    ...
    print(
        f"Generated {num_samples} transactions ({num_fraud} fraud, {num_legitimate} legitimate)"
    )
